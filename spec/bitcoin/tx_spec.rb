...
a9143c82d7df364eb6c75be8c80df2b3eda8db57397088ac46430600"
  ...
  describe '#serialize' do
    ...
    # TODO: Completar
    let(:raw_tx) do
      hex_to_byte_stream('')
    end

    it 'returns the correct serialize' do
      # TODO: Completar
      tx = described_class.parse(raw_tx)
      expect(tx.serialize()).to eq raw_tx
    end
  end
